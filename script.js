...
const displayErrorMsgs = msgs => {
    ...
    const node = $(".register-section ul");
    if (node == null) {
        const form = $(".register-section form");
...
const processEntries = () => {
    ...
    if (full_name.value == "") { msgs[msgs.length] = "Please enter your full name.";}
    if (email.value == "")     { msgs[msgs.length] = "Please enter an email address.";}
    if (phone.value == "")     { msgs[msgs.length] = "Please enter a mobile phone number.";}
    if (city.value == "")      { msgs[msgs.length] = "Please select a city.";}
    if (terms.checked == false){ msgs[msgs.length] = "You must agree to the terms of service.";}
    if (comments.value == "")  { msgs[msgs.length] = "Please enter a comment.";}
...
const resetForm = () => {
    $(".register-section form").reset();
    $(".register-section ul").remove();
    $("#full_name").focus();
};
